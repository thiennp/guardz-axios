 ...
 */
export const isAxiosError: TypeGuardFn<AxiosError> = function (
  value: unknown,
  _config?: any,
): value is AxiosError {
 ...
 */
export const isAxiosErrorWithResponse: TypeGuardFn<ResponseError> = function (
  value: unknown,
  config?: any,
): value is ResponseError {
 ...
 */
export const isNetworkError: TypeGuardFn<NetworkError> = function (
  value: unknown,
  config?: any,
 ...
 */
export const isTimeoutError: TypeGuardFn<TimeoutError> = function (
  value: unknown,
  config?: any,
 ...
 */
export const isCancelError: TypeGuardFn<CancelError> = function (
  value: unknown,
  config?: any,
): value is CancelError {
  if (!isAxiosError(value, config)) {
    return false;
  }
 ...
 */
export const isClientError: TypeGuardFn<
  AxiosError & { response: AxiosResponse & { status: ClientErrorStatus } }
> = function (
  value: unknown,
  config?: any,
): value is AxiosError & {
  response: AxiosResponse & { status: ClientErrorStatus };
} {
 ...
 */
export const isServerError: TypeGuardFn<
  AxiosError & { response: AxiosResponse & { status: ServerErrorStatus } }
> = function (
  value: unknown,
  config?: any,
): value is AxiosError & {
  response: AxiosResponse & { status: ServerErrorStatus };
} {
  if (!isAxiosErrorWithResponse(value, config)) {
    return false;
  }
 ...
 */
export const isAuthenticationError: TypeGuardFn<
  AxiosError & { response: AxiosResponse & { status: 401 } }
> = function (
  value: unknown,
  config?: any,
): value is AxiosError & { response: AxiosResponse & { status: 401 } } {
  if (!isAxiosErrorWithResponse(value, config)) {
    return false;
  }
 ...
 */
export const isAuthorizationError: TypeGuardFn<
  AxiosError & { response: AxiosResponse & { status: 403 } }
> = function (
  value: unknown,
  config?: any,
): value is AxiosError & { response: AxiosResponse & { status: 403 } } {
  if (!isAxiosErrorWithResponse(value, config)) {
    return false;
  }
 ...
 */
export const isNotFoundError: TypeGuardFn<
  AxiosError & { response: AxiosResponse & { status: 404 } }
> = function (
  value: unknown,
  config?: any,
): value is AxiosError & { response: AxiosResponse & { status: 404 } } {
  if (!isAxiosErrorWithResponse(value, config)) {
    return false;
  }
 ...
 */
export const isValidationError: TypeGuardFn<
  AxiosError & { response: AxiosResponse & { status: 422 } }
> = function (
  value: unknown,
  config?: any,
): value is AxiosError & { response: AxiosResponse & { status: 422 } } {
  if (!isAxiosErrorWithResponse(value, config)) {
    return false;
  }
 ...
 */
export const isRateLimitError: TypeGuardFn<
  AxiosError & { response: AxiosResponse & { status: 429 } }
> = function (
  value: unknown,
  config?: any,
): value is AxiosError & { response: AxiosResponse & { status: 429 } } {
  if (!isAxiosErrorWithResponse(value, config)) {
    return false;
  }
 ...
 */
export function isErrorWithStatus<T extends number>(
  statusCode: T,
): TypeGuardFn<AxiosError & { response: AxiosResponse & { status: T } }> {
  return function (
    value: unknown,
    config?: any,
  ): value is AxiosError & { response: AxiosResponse & { status: T } } {
    if (!isAxiosErrorWithResponse(value, config)) {
      return false;
    }
...
export function isErrorWithCode<T extends string>(
  errorCode: T,
): TypeGuardFn<AxiosError & { code: T }> {
  return function (
    value: unknown,
    config?: any,
  ): value is AxiosError & { code: T } {
    if (!isAxiosError(value, config)) {
      return false;
    }
